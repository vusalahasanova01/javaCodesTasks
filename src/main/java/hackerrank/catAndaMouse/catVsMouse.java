...
public class catVsMouse {
    ...
    public static ArrayList<String> mouse1() {
        ...
        for (int i = 0; i < quantity; i++) {
            ...
            if ((Math.abs(numbers.get(2) - numbers.get(1)) > (Math.abs(numbers.get(2) - numbers.get(0)))))
                name.add("Cat A");
            else if ((Math.abs(numbers.get(2) - numbers.get(1)) < (Math.abs(numbers.get(2) - numbers.get(0)))))
                name.add("Cat B");
